    ...
    <tr class="col_headers light_row">
      ...
      <td class="normalday">
        ...
        <ul class="day_agenda">
          <li>
            <span class="tag topic_tag">Topic:</span>
            <span>The Ethics of Generative Models in Sociotechnical Systems [<a href="https://docs.google.com/presentation/d/18GT8Ja3d8dEh1E7BAbHMzIbEPSXfA29-LFg2r3-zR20/edit?usp=sharing">slides</a>]. Guest Lecture: Prof. <a href="https://www.wellesley.edu/people/mariah-caballero">Mariah Caballero</a>.</span>
          </li>
          <li>
            <span class="tag preclass_tag">Pre-Class:</span>
            <span><ul>
